package nl.evertwoud.higherlowerdice;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initViews() {
        ...
        mRecentScores = findViewById(R.id.recent_list);
        mUpButton = findViewById(R.id.button_up);
        mDice = findViewById(R.id.dice);
        mDownButton = findViewById(R.id.button_down);
